...
app.MapGet("/api/countries", (IDataService dataService, int startIndex, int? count) => dataService.GetCountriesAsync(startIndex, count, "Name", true, CancellationToken.None));
